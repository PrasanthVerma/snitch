        ...
        <div className="flex flex-col gap-8">
          ...
          <nav className="flex flex-col gap-1">
            {[
              ...
              { label: 'Inventory', icon: 'M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z',
                      ...
                      <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-500/5 text-xs font-light">
                          {filteredAndSortedProducts.map((product) => {
                            ...
                            const seededStock = product.stock;
                                ...
                                <td className="py-4 pl-4 text-right whitespace-nowrap">
                                  <div className="flex items-center justify-end gap-2.5">
                                    ...
                                    <button
                                       ...
                                       className={`p-1.5 text-gray-600 opacity-40 hover:opacity-100 hover:text-red-500 transition-colors`}

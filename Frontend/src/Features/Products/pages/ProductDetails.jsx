...
const ProductDetails = () => {
  ...
  const { fetchProductById, fetchAllProducts } = useProduct()
  ...
  // Calculate seeded MRP and discount percentage
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative hidden lg:block w-56">
              <input
                ...
                className={`w-full text-[11px] py-2 pl-4 pr-9 rounded-full border focus:outline-none transition-all font-light ${
                  isDarkMode
      ...
      <main className="max-w-[1240px] mx-auto w-full px-6 sm:px-8 md:px-12 py-10 flex-1 flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
          ...
          <div className="lg:col-span-7 flex flex-col md:flex-row gap-4">
            ...
            <div className="hidden md:flex flex-col gap-3 w-20 shrink-0 select-none">
              {productImages.map((img, idx) => (
                <button
                  ...
                  className={`aspect-[3/4] rounded-lg overflow-hidden border transition-all duration-300 ${
                    idx === activeImgIndex
            ...
            {/* Main Display frame */}
            <div className={`flex-1 aspect-[3/4] rounded-2xl overflow-hidden relative border transition-all duration-300 select-none ${
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="space-y-3">
              ...
              <h2 className={`text-3xl sm:text-4xl font-luxury-serif font-light leading-tight ${
                isDarkMode ? 'text-white' : 'text-black'
              }`}>
                {product.name}
              </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-3">
              ...
              <button
                type="button"
                className={`flex-1 py-3.5 px-6 rounded-xl font-semibold text-xs tracking-widest uppercase transition-all duration-300 border flex justify-center items-center gap-2 select-none cursor-pointer ${
                  isDarkMode
              ...
              <button
                type="button"
                className={`p-3.5 rounded-xl border flex items-center justify-center shrink-0 transition-all duration-300 hover:text-red-500 ${
                  isDarkMode
            ...
            <div className={`mt-2 p-4 rounded-xl border grid grid-cols-3 gap-2 text-center transition-colors duration-300 ${
              isDarkMode ? 'bg-[#0D0D0D] border-white/5' : 'bg-gray-50 border-[#E5E5EA]'
            }`}>
        ...
        {recommendations.length > 0 && (
          <section className="pt-10 border-t border-dashed border-gray-500/10 space-y-8">
            <div className="flex justify-between items-center">
              <h3 className={`text-xl font-luxury-serif font-light tracking-wide ${
                isDarkMode ? 'text-white' : 'text-black'
              }`}>
                You may also like
              </h3>
              ...
              <button className={`p-2.5 rounded-full border transition-all duration-300 ${
              ...
              {recommendations.map((item) => {
                ...
                return (
                  <article
                    ...
                    className={`group border rounded-xl overflow-hidden flex flex-col relative transition-all duration-500 cursor-pointer ${
                  ...
                  >
                    ...
                    <div className="p-4 flex-1 flex flex-col justify-between gap-3">
                      <div className="space-y-1">
                        <h4 className={`text-sm font-semibold truncate transition-colors group-hover:text-[#C5A880] ${
                          isDarkMode ? 'text-white' : 'text-black'
                        }`}>
                          {item.name}
                        </h4>
                        <p className={`text-[11px] font-light line-clamp-1 ${
                          isDarkMode ? 'text-gray-500' : 'text-gray-400'
                        }`}>
                          {item.description}
                        </p>
